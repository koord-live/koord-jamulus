...
/* Classes ********************************************************************/
class CChannelFaderNu : public QObject
{
    Q_OBJECT
...
public:
    ...
    bool    IsVisible() { return true; } //FIXME return !pFrame->isHidden(); }
    bool    IsSolo() { return true; } //FIXME return pcbSolo->isChecked(); }
    bool    IsMute() { return true; } //FIXME return pcbMute->isChecked(); }
    ...
    int    GetFaderLevel() { return 1; } //FIXME return pFader->value(); }
    double GetPreviousFaderLevel() { return 1.0; } //FIXME return dPreviousFaderLevel; }
    int    GetPanValue() { return 1; } //FIXME return pPan->value(); }
    void   Reset();
...
// class CAudioMixerBoardNuSlots : public CAudioMixerBoardNuSlots<slotId - 1>
// {
// public:
...
// template<>
// class CAudioMixerBoardNuSlots<0>
// {};

// class CAudioMixerBoardNu : public CAudioMixerBoardNuSlots<MAX_NUM_CHANNELS>
class CAudioMixerBoardNu : public QObject //FIXME - ????
{
    Q_OBJECT

public:
    CAudioMixerBoardNu ( QObject* parent = nullptr );

    virtual ~CAudioMixerBoardNu();
...
protected:
    ...
    void StoreFaderSettings ( CChannelFaderNu* pChanFader );
    void UpdateSoloStates();
    void UpdateTitle();

    CClientSettings*        pSettings;
    CVector<CChannelFaderNu*> vecpChanFader;
