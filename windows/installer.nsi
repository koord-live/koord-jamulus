; Koord-RealTime NSIS Installer with Modern User Interface
...
!macro SetupShortcuts
    ...
    WriteRegStr "HKCR" "koord\shell\open\command" "" '"c:\Program Files\Koord-RealTime\Koord-RealTime.exe" "-x" "%1"'
...
Section "Install_64Bit" INST_64
    ; check if old, wrongly installed Koord-RealTime exists. See https://stackoverflow.com/questions/27839860/nsis-check-if-registry-key-value-exists#27841158
    IfFileExists "$PROGRAMFILES32\Koord-RealTime\Uninstall.exe" 0 continueinstall
        ...
        removeold: ; Remove it
            ExecWait '"$PROGRAMFILES32\Koord-RealTime\Uninstall.exe" /S' $0
            ${IfNot} $0 == 0
...
; Ensure Koord-RealTime is installed into a new folder only, unless Koord-RealTime is already installed there
